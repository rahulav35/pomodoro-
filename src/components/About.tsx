...
function About() {
  return (
    <div className='w-11/12 mx-auto mt-5 text-white '>
        ...
        <p className='mt-3 tracking-wide opacity-70 text-sm mb-3'>
        ...
        <span className="text-xl sm:text-2xl font-medium mt-10 ">
            <span className='border-b-2 border-red-400'>What</span> is Daily Focus?
        </span>
        <p className='mt-3 tracking-wider opacity-70 text-sm'>
